...
insert into tb_contatos(id,nome,fone) values(4, 'Guilherme Henrique', '99194-8567');
insert into tb_contatos(id,nome,fone,email) values(5, 'Testa', '56255610', 'ts.hjh@hot.com');
